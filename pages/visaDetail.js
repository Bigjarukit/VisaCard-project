    ...
    <div className='CPNcolor'>
      ...
      <div style={{ padding: 20 }}>
        ...
        <div className='BoxCPN'>
          <div>
            <Box sx={{ flexGrow: 1 }}>
              <Grid container spacing={2} style={{paddingLeft:"30px"}} className='textgrey2' >
                <Grid item xs={3}>
                  <div style={{ fontSize: "18px" }}>42012</div>
                </Grid>
                <Grid item xs={3}>
                  <div style={{ fontSize: "18px" }}>3049</div>
                </Grid>
                <Grid item xs={3}>
                  <div style={{ fontSize: "18px" }}>3049</div>
                </Grid>
                <Grid item xs={3}>
                  <div style={{ fontSize: "18px" }}>9815</div>
                </Grid>
            ...
            {/* <div style={{ padding: "0px 0px 0px 35px" }}>
              <div style={{ fontSize: "18px" }} className='textgrey2'>42012 &emsp;3049 &emsp;3049 &emsp;9815</div>
            </div> */}
          </div>
          <Box sx={{ flexGrow: 1 }}>
              <Grid container spacing={2} style={{paddingLeft:"30px"}} className='textgrey2' >
                <Grid item xs={8}>
                  <div className='textgrey2'>EXPIRE&emsp;02/22</div>
                </Grid>
                <Grid item xs={4}>
                  <div className='textgrey2'>CVC CODE:&emsp;230</div>
                </Grid>
